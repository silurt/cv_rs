...
//!
//! Widths are in 1/1000 em, indexed by WinAnsi byte; kern pairs are sorted for
//! binary search. Widths drive line breaking, so a systematic error here shifts
//! every wrap point in the document.
//!
//! Generated by `scripts/gen-metrics.mjs`; do not edit by hand.
